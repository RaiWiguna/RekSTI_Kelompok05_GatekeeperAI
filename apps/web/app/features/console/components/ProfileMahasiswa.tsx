      ...
      <main className="main-content">
        ...
        <div className="profile-display">
          <div className="avatar-large-container">
            <img 
              src="https://ui-avatars.com/api/?name=Aliya&background=FFC107&color=fff&rounded=true&bold=true" 
              alt="Profile" 
              className="avatar-large"
            />
          </div>
          <h2 className="user-full-name">Aliya Harta Ary Utama</h2>
          <p className="user-email">18223081@mahasiswa.itb.ac.id</p>
